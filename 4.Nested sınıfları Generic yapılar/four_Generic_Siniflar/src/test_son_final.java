public class test_son_final <T1,T2,T3>{
    private T1 obj1;
    private T2 obj2;
    private T3 obj3;

    public test_son_final(T1 obj1, T2 obj2, T3 obj3) {
        this.obj1 = obj1;
        this.obj2 = obj2;
        this.obj3 = obj3;
    }
    ...
    public void  showInfo(){
        System.out.println("T1 :"+obj1+" : "+obj1.getClass().getSimpleName());   //getSimpleName türünün adını veriyor
